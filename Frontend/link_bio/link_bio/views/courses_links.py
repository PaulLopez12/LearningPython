...
def courses_links() -> rx.Component:
    return rx.vstack(
        tittle("Cursos gratis"),
        link_button("Desarrollo con IA",
                    "Curso de 3h de desarrollo con IA con certidicado gratis",
                    "/icons/ai-svgrepo-com.svg", 
                    const.DEVIA_COURSE_URL,
                    Color.PRIMARY.value),
        
        link_button("Bash/Shell desde cero",
                    "Curso de 6h de terminal, línea de comandos y scripting",
                    "/icons/terminal.svg", 
                    const.BASH_COURSE_URL,
                    Color.PRIMARY.value),
        
        link_button("Java y POO desde cero",
        ...
        link_button("Guías de programación",
                    "Mi listado de guías en PDF para aprender desarrollo",
                    "/icons/book.svg", 
                    const.BOOK_URL,
                    Color.GREEN.value),
